...
조교 관리 및 현황판  
![조교 관리 및 현황판](./images/tas.png)  
![조교 배정 현황](./images/taDashboard.png)  

수업 및 조교 추가/삭제 기능 (자동배정 수동배정 모두 가능)
![수업 및 조교 추가](./images/AddOrDelete.png)  
...
**각 요일을 선택하실 수 있고 강의 시간, 선생님을 선택하거나 직접 추가하실 수 있습니다.**
**임의로 조교를 추가하고 수업을 추가하여 자동배정을 확인하실 수 있습니다.**  
**자동배정 시 배정이 안된 수업이 있을 수 있습니다.(ex. 3연강 규칙 때문에 배정이 안 된 경우) 그 시간에 직접 배정으로 배정하시면 됩니다.**  
**수업을 추가할 때 수업이 중복되지 않도록 확인하시고 추가해주세요.**  
**빠른 확인을 위해 임의로 조교 및 수업시간 데이터를 추가해 뒀습니다. 프로그램 실행하신 후 바로 자동배정 버튼 클릭을 통해 자동배정 현황을 보실 수 있습니다**
